            ...
            >
              <div className={`flex items-center gap-8 ${index % 2 === 1 ? 'flex-row-reverse' : ''}`}>
                ...
                <motion.div
                  ...
                  className="flex-1 p-6 md:p-8 bg-[#151B2E] rounded-lg sketchy-border-pink border-2 border-[#FF4D6D] border-opacity-50"
                >
              ...
              {index < timelineData.length - 1 && (
                <div className="absolute left-6 top-20 w-0.5 h-16 bg-gradient-to-b from-[#FF4D6D] to-transparent" />
              )}
            </motion.div>
          ))}
        </div>
